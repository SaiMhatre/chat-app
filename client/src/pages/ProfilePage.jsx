      ...
      border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form action="" className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <label htmlFor="avatar" className='flex items-center gap-3 cursor-pointer'>
            ...
            <img src={selectedImg ? URL.createObjectURL(selectedImg) : assets.avatar_icon} alt="avatar" 
        ...
        <img src={authUser?.profilePicture || assets.logo_icon} alt='' className={`max-w-44 aspect-square rounded-full mx-10 max-sm:mt-10 

...
const LoginPage = () => {
  ...
  return (
    ...
    gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 w-[332px] flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {!isDataSubmitted && (
          ...
          type='email' placeholder='Email Adress' required className='p-2 border 
        ...
        {currState === 'Sign up' && isDataSubmitted && (
            ...
            focus:ring-2 focus:ring-indigo-500' value={bio} onChange={(e) => setBio(e.target.value)}
        ...
        { currState === 'Sign up' && <div className='flex items-center gap-2 text-sm text-gray-400'>
